package com.bullet.architecture.core.component.logger.configuration

import com.bullet.architecture.domain.component.logger.configuration.BaseLoggerConfiguration
